...
- [Kubernets](#kubernets)
  - [Sumário](#sumário)
- [O que é Kubernets?](#o-que-é-kubernets)
  - [O que o Kubernetes pode fazer?](#o-que-o-kubernetes-pode-fazer)
  - [O que o Kubernetes não é](#o-que-o-kubernetes-não-é)
- [Tipos de serviços no Kubernetes](#tipos-de-serviços-no-kubernetes)
  - [O que é um serviço no Kubernetes?](#o-que-é-um-serviço-no-kubernetes)
    - [Por que usar um serviço do Kubernetes?](#por-que-usar-um-serviço-do-kubernetes)
  - [ClusterIP](#clusterip)
  - [NodePort](#nodeport)
  - [LoadBalancer](#loadbalancer)
  - [ExternalName](#externalname)
  - [Headless](#headless)
    - [Com seletores](#com-seletores)
    - [Sem seletores](#sem-seletores)
- [O que é Kind?](#o-que-é-kind)
...
- [Comandos do Kubernets e do Kind](#comandos-do-kubernets-e-do-kind)
- [Comandos úteis do Linux](#comandos-úteis-do-linux)
- [Configurações de objetos](#configurações-de-objetos)
...
- [Health check](#health-check)
  ...
  - [Configurando Probes](#configurando-probes)
